...
const scholarshipSchema = new mongoose.Schema(
  {
    ...
    applicationFees: { type: Number, required: true, default: 0, index: true },
    serviceCharge: { type: Number, required: true, default: 0 },
    applicationDeadline: { type: Date, required: true, index: true },
    scholarshipPostDate: { type: Date, default: Date.now, index: true },
    postedUserEmail: { type: String, required: true },
    description: { type: String, default: "" },
    stipendDetails: { type: String, default: "" },
  },
  { timestamps: true }
);
